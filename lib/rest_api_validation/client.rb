  ...
  def path_template(params_with_sym_keys={})
    ...
    params_with_sym_keys.each_pair { |k,v| params[k.to_sym] = v }
    {
      index: {
        ...
        web_forms:   "/workspaces/#{params[:workspace_id]}/hosts/#{params[:host_id]}/services/#{params[:service_id]}/web_sites/#{params[:web_site_id]}/web_forms",
        web_pages:   "/workspaces/#{params[:workspace_id]}/hosts/#{params[:host_id]}/services/#{params[:service_id]}/web_sites/#{params[:web_site_id]}/web_pages",
        web_vulns:   "/workspaces/#{params[:workspace_id]}/hosts/#{params[:host_id]}/services/#{params[:service_id]}/web_sites/#{params[:web_site_id]}/web_vulns",
      ...
      show: {
        ...
        web_form:   "/workspaces/#{params[:workspace_id]}/hosts/#{params[:host_id]}/services/#{params[:service_id]}/web_sites/#{params[:web_site_id]}/web_forms/#{params[:web_form_id]}",
        web_page:   "/workspaces/#{params[:workspace_id]}/hosts/#{params[:host_id]}/services/#{params[:service_id]}/web_sites/#{params[:web_site_id]}/web_pages/#{params[:web_page_id]}",
        web_vuln:   "/workspaces/#{params[:workspace_id]}/hosts/#{params[:host_id]}/services/#{params[:service_id]}/web_sites/#{params[:web_site_id]}/web_vulns/#{params[:web_vuln_id]}",
